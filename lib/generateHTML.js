const profileCards = [
    { name: 'd', role: 'Manager', id: 1, email: 'w', officeNumber: 1 },
    { name: 'd', role: 'Engineer', id: 2, email: 'e', github: 'w' },
    { name: 'e', role: 'Intern', id: 3, email: 'f', school: 'f' }
];
...
function generateHTML(profileCards) {
    ...
    const createCardHTML = (card, icon, uniqueListItem) => {
        return `
                <div class="card mx-auto px-0 col-3">
...
<html lang="en-US">
    <head>
        ...
        <!--Fonts-->
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Oswald&family=Quattrocento:wght@400;700&display=swap"/>
        <!--Custom styling-->
        ...
        <!--Profile cards-- >
            <div class="container-fluid">
                <div class="row d-flex justify-content-between">${totalCardHTML}
                </div>
            </div>
